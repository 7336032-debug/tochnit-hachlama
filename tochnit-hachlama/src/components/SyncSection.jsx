...
export default function SyncSection() {
  ...
  return (
    <div className="stack">
      <p className="sync-hint">
                  גיבוי/העברה ידניים - שימושי כגיבוי נוסף לסנכרון האוטומטי. מייצאים קוד במכשיר אחד ומייבאים אותו במכשיר
                  השני. לא אוטומטי (צריך לחזור על זה כל פעם שרוצים לעדכן מכשיר אחר), אבל עובד תמיד בלי תלות באינטרנט או
                  בשירות חיצוני.
      </p>
